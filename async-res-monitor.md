...
This is given in the diagram of dependencies in figure [@fig:deps], and the stack diagram in figure \ref{fig:deps-block-stack}.
...
# Inbox List Controlling Finite State Machine}
\label{inbox-list}
